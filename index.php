...
<div id="container">
            ...
            <div class="swiper mainSwiper">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide mainSlide">
                        <img class="mainSwiperImages" src="https://picsum.photos/800/500" alt="">
                    </div>

                    <div class="swiper-slide mainSlide">
                        <img class="mainSwiperImages" src="https://picsum.photos/800/499" alt="">
                    </div>

                    <div class="swiper-slide mainSlide">
                        <img class="mainSwiperImages" src="https://picsum.photos/800/498" alt="">
                    </div>
                </div>
    ...
    <div class="section">
        <div class='underSection'>
            <div><h1 class='mainColor titleSize'>Watch to Watch</h1></div>
        ...
        <!-- Fan favorites under category

        More to watch under category
            Exclusive videos Category
                        IMDb Originals under category
        ...
        <div class="section">
            ...
            <div class="section">
                ...
                <div class="section">
                        ...
                        <div class="underSection secondUnderSection">
                            ...
                            <div id="boxOfficeContainer">
                                <div class="boxOffice">
                                    ...
                                    <div class="containerLogoBoxOffice"><i
                                                class="fas fa-plus-circle box-office-logo"></i> 1
                                    </div>
                                ...
                                <div class="boxOffice linearGradientBg">
                                    <div class="line yellowBorder"></div>
                                    <div class="containerLogoBoxOffice"><i
                                                class="fas fa-plus-circle box-office-logo"></i> 4
                                    </div>
                                ...
                                <div class="boxOffice linearGradientBg">
                                    <div class="line yellowBorder"></div>
                                    <div class="containerLogoBoxOffice"><i
                                                class="fas fa-plus-circle box-office-logo"></i> 2
                                    </div>
                                ...
                                <div class="boxOffice">
                                    <div class="line yellowBorder"></div>
                                    <div class="containerLogoBoxOffice"><i
                                                class="fas fa-plus-circle box-office-logo"></i> 5
                                    </div>
                                ...
                                <div class="boxOffice">
                                    <div class="line yellowBorder"></div>
                                    <div class="containerLogoBoxOffice"><i
                                                class="fas fa-plus-circle box-office-logo"></i> 3
                                    </div>
                                ...
                                <div class="boxOffice linearGradientBg">
                                    <div class="line yellowBorder"></div>
                                    <div class="containerLogoBoxOffice"><i
                                                class="fas fa-plus-circle box-office-logo"></i> 6
                                    </div>
                    ...
                    <div class="section">
                        <div class="underSection secondUnderSection">
                            <h2 class="topPicksTitle">Coming soon to theaters (US) <span class="yellowHover">></span>
                            </h2>
                    ...
                    <div class="section">
                        ...
                        <div class="swiper mySwipe3Slide swiper3SlideSizeDiff">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide topNewsSlides">
                                    <img class="topNewsSlidesImage" src="https://picsum.photos/430/250" alt="">
                                    <div>‘Yellowstone’ Season 4 Finale Wrangles Over 10 Million Viewers, Up 81% From
                                        Season 3
                                        Finale
                                ...
                                <div class="swiper-slide topNewsSlides">
                                    <img class="topNewsSlidesImage" src="https://picsum.photos/430/250" alt="">
                                    <div>Vanessa Kirby to Replace Jodie Comer in Ridley Scott’s ‘Kitbag’ With Joaquin
                                        Phoenix
                                ...
                                <div class="swiper-slide topNewsSlides">
                                    <img class="topNewsSlidesImage" src="https://picsum.photos/430/250" alt="">
                                    <div>HBO and HBO Max Rounded Out 2021 With 73.8 Million Global Subscribers, Topping
                                        Estimates
                                        <div>Jan 5 Variety - TV News</div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide topNewsSlides">
                                    <img class="topNewsSlidesImage" src="https://picsum.photos/430/250" alt="">
                                    <div>‘Venom’ and Bond Still Lead VOD Charts as ‘Lost Daughter’ Makes Impressive
                                        Netflix
                                        Debut
